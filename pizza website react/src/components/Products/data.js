...
/** In MERN created websites i will create a DB using mongo and connect to it, 
 * create a schema, and save data in DB like that.
 * 
 * Now it is done here, in local JS file.
 */
